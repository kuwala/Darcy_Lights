...
void loop() {
  ...
  /////////// EXPERIMENTAL ZONE
    ...
    int pins[] = {0, 1, 29, 30, 15, 16, 17, 18, 19, 23};
    int thresholds[] = {1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000};
  ...
  //const unsigned int audioSamples[] = {AudioSample1,AudioSample2,AudioSample3,AudioSample4,AudioSample5,AudioSample6,AudioSample7,AudioSample8,AudioSample9,AudioSample10};
    ...
    int evens[] = {0,2,4,6,8,10,0,2,4,6};
    int odds[] = {1,3,5,7,9,1,3,5,7,9};
    for (int i = 0; i < 10; i++) {
